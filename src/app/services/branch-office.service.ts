...
export class BranchOfficeService {
  ...
  availableInventory: Equipment[] = [{imageURL: 'Equipo 1', Tipo_Equipo: 'Tipo 1', Marca: 'Brand 1', Serial: '000', Costo: 1000, Sucursal: 'Site'}, {imageURL: 'Equipo 1', Tipo_Equipo: 'Tipo 1', Marca: 'Brand 1', Serial: '000', Costo: 1000, Sucursal: 'Site'}, {imageURL: 'Equipo 1', Tipo_Equipo: 'Tipo 1', Marca: 'Brand 1', Serial: '000', Costo: 1000, Sucursal: 'Site'}];
